...
def background(currentState,backY):
  if currentState == "menu":
    ...
    screen.blit(cloudButton,(200,-80,500,400)) #Play Game Button
    screen.blit(cloudButton,(200,120,500,400)) #Characters Button
    screen.blit(cloudButton,(200,320,500,400)) #Instructions Button
    screen.blit(menuFont.render("Play Game", 1, BLACK),(280,100,500,150))
    screen.blit(menuFont.render("Characters", 1, BLACK),(280,300,500,150))
    screen.blit(menuFont.render("Instructions", 1, BLACK),(280,500,500,150))
  ...
  if currentState == "done":
    #black background
    screen.blit(cloudSky,(0,0,1000,700))
    screen.blit(doneFont.render("Game Over", 1, BLACK),((centreBox(0,0,1000,700,500,500)[0],50,500,500)))
    #Play again button
    ...
    #Score
    screen.blit(doneFont.render("Score: " + str(score), 1, BLACK),(centreBox(0,0,1000,700,500,500)[0],250,500,500))
...
while running:
  ...
  for e in event.get():  # checks all events that happen
    ...
    if e.type == MOUSEBUTTONDOWN:
      #home menu
      if currentState == "menu":
        if e.pos[0] >= 200 and e.pos[0] <= 700 and e.pos[1] >= 50 and e.pos[1] <= 200: #Play game button clicked
          currentState = "game"
          #resets to normal
        ...
        if e.pos[0] >= 200 and e.pos[0] <= 700 and e.pos[1] >= 250 and e.pos[1] <= 400: #Characters button clicked
          currentState = "characters"
        
        if e.pos[0] >= 200 and e.pos[0] <= 700 and e.pos[1] >= 450 and e.pos[1] <= 600: #Characters button clicked
